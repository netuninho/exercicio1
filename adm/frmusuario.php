...
$op = isset($_GET["op"]) ? $_GET["op"]: null;
    ...
    try {
        ...
        if($_POST){
            if($_POST["idusuario"]){
                $sql = "UPDATE tblusuarios SET nome=:nome, email=:email, senha=:senha, idsituacao=:idsituacao, idnivelacesso=:idnivelacesso, criado=:criado  WHERE idusuario =:idusuario";
                $stmt = $con->prepare($sql);
...
<div class="container">
    ...
    <form method="POST">
        ...
        Email <input type="text"  name="email"  class="form-control"     value="<?php echo isset($tblusuarios) ? $tblusuarios->email : null ?>"><br>
